...
bool    GameLayerPlant_Level_2::init()
{
    GameLayerPlant::init();
    return true;
}
void  GameLayerPlant_Level_2::moveDown(float yLen)
{
    GameLayerPlant::moveDown(yLen);
    _leafs.moveDownLeafs(yLen);
    // _leafHelper.moveDownLeafs(yLen);
}
void  GameLayerPlant_Level_2::update(float dt)
{
...
void GameLayerPlant_Level_2::onPlantHeightChange(float height,int index)
{
    if(index >0)return;
    if (height < 0 ) {
...
#include "ItemModel.h"
PlantGrowContext  GameLayerPlant_Level_2::getPlantGrowContextAngle(PlantNode* plant)
{
...
float  GameLayerPlant_Level_2::growByIndex(float length,int index)
{
...
float   GameLayerPlant_Level_2::reGrowByIndex(float length,int index)
{
