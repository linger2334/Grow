...
void LevelFileHandler::loadFile()
{
    ...
    //
    std::string documentPath = FileUtils::getInstance()->fullPathForFilename(_filename + ".xml");
    ...
    //
    std::string plistPath = FileUtils::getInstance()->fullPathForFilename(_filename + "polygons.plist");
