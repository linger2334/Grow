...
#ifndef __Grow__GameConstants__
#define __Grow__GameConstants__
...
extern const float kDefaultZoomStep;

extern const float kDefaultAngle;
...
extern const float kDefaultAnimationRotation;
extern const float kDefaultAnimationRotationSpeed;
extern const float kDefaultAnimationMoveSpeed;
extern const Vec2 kDefaultAnimationPosition;
...
extern const float kDefaultDragonBackTransparency;
extern const float kDefaultDragonBellyTransparency;

extern const float kDefaultSerpentAbsorptionRate;
extern const float kDefaultSerpentHoleTransparency;
...
extern const float kDefaultPathPointLineWidth;
