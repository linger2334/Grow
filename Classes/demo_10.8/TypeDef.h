...
{
    left_bottom = 0x00,  //LeftBottom
    left_top = 0x02,  //LeftTop
    right_bottom = 0x04,  //RightBottom
    right_top = 0x08,  //RIghtTop
    center_bottom = 0x10,  //CenterBottom
    center_top = 0x20   //CenterTop
};
